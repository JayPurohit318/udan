...
//               </li>
//               <li>
//                 <Link to="/policies" className="hover:text-secondary transition-colors">Policies</Link>
//               </li>
//             </ul>
//           </div>
...
//                 <form><script src="https://oneclick.payglocal.in/simple.js" data-pb-id="pb_0fOAFdVn8CZ1"></script></form>
//               </Button>
//             </div>
//           </div>
//         </div>
...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    script.setAttribute("data-pb-id", "pb_0fOAFdVn8CZ1"); // put your real button ID back here
...
<div className="mt-4" ref={paymentRef}></div>
</div>
</div>
</div>
